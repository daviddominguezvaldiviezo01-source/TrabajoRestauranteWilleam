    ...
    <style>
        * {
        ...
        .promociones-section {
            ...
            /* menos espacio inferior para acercar la barra de categorías */
            width: 100%;
            background: #0d0d0d;
            display: flex;
            flex-direction: column;
        ...
        .promo-speed-btn:hover {
            background: rgba(255, 255, 255, .14);
            color: rgba(255, 255, 255, .8);
        }

        .promo-speed-btn.active {
            background: #c8102e;
            border-color: #c8102e;
            color: #fff;
        }
        ...
        .toast-msg.error {
            ...
            background: rgba(192, 23, 50, 0.98);
        }
        ...
        .toast-msg.error .toast-icon i {
            color: #ffe5e5;
        }

        .toast-msg.success {
            border-left-color: #ff2a4f;
            background: rgba(200, 16, 46, 0.98);
        }

        .toast-msg.success .toast-icon i {
            color: #fff;
        }
